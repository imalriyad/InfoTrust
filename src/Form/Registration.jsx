    ...
    <div>
      <section className="relative z-10 overflow-hidden bg-black text-white py-5 lg:py-[40px]">
        <div className="container mx-auto">
          ...
          <div className="flex md:flex-row-reverse flex-col flex-wrap -mx-4 lg:justify-between">
            <img
              src="/src/assets/undraw_bitcoin_p2p_re_1xqa.svg"
              className="px-4"
              alt=""
            />
            <div className="px-4 lg:w-[35%] w-full">
