...
const States = () => {
  ...
  return (
    <>
      ...
      <div className={`lg:hidden block cursor-pointer drop-shadow-md space-y-4 rounded-sm col-span-10 md:col-span-full ${isOpen ? 'hidden':'block'}`}>

     <div className='flex justify-center gap-5 px-2'>
     <span className="flex gap-3 items-center md:w-full w-1/2 bg-[#2f3542] p-2"><GiWallet className="text-2xl text-mainColor"></GiWallet><span className='flex flex-col'><h1 className="text-secondColor font-medium text-xs"> Total Balance</h1>
        <h1 className="font-semibold text-white text-lg">$240.74</h1></span></span>
        <span className="flex gap-3 items-center md:w-full w-1/2 bg-[#2f3542] p-2"><GiWallet className=" text-2xl text-mainColor"></GiWallet><span className='flex flex-col'><h1 className="text-secondColor font-medium text-xs">Total Spent</h1>
        <h1 className="font-semibold text-white text-lg">$240.74</h1></span></span>

     
     </div>
     <div className='flex justify-center gap-5 px-2 '>
     <span className="flex gap-3 items-center md:w-full w-1/2 bg-[#2f3542] p-2"><GiWallet className="text-2xl text-mainColor"></GiWallet><span className='flex flex-col'><h1 className="text-secondColor font-medium text-xs"> Total Profit</h1>
        <h1 className="font-semibold text-white text-lg">$240.74</h1></span></span>
        <span className="flex gap-3 items-center md:w-full w-1/2 bg-[#2f3542] p-2"><GiWallet className=" text-2xl text-mainColor"></GiWallet><span className='flex flex-col'><h1 className="text-secondColor font-medium text-xs">Total Reffer</h1>
        <h1 className="font-semibold text-white text-lg">24</h1></span></span>
